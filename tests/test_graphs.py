...
from graphs.kruskals_algorithm import get_mst_kruskal
...
class TestBreadthFirstTraversal(unittest.TestCase):
    def test_breadth_first_traversal(self):
        ...
        results = list(
            graphs.breadth_first_traversal.breadth_first_traversal(graph, 2)
        )
...
class TestDisjointSet(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        so that changes to it aren't carried between tests
        :return:
        """
    ...
    def test_find(self):
        ...
        the find function takes a numeric id for a node
        and returns the Node object that is the id
        """
        for i in range(4):
        ...
        # if the find step doesn't skip a value,
        # the node's parent should immediately follow (in this example)
    ...
    def test_union(self):
        ...
        self.assertEqual(self.disjoint_set.tree[0].parent.id,
                         self.disjoint_set.tree[1].id)
